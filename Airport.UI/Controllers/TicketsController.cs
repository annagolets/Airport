    ...
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Tickets != null ? 
                          ...
                          Problem("Entity set 'Context.Tickets'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NumberSeat,Cost")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,NumberSeat,Cost")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
